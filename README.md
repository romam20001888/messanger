...
<ol>
    <li>Администратор. Пользователь обладает полными правами. Может создавать, редактировать и удалять новости. Производит модерацию пользователей (проставляет группы пользователей) и определяет является пользователь студентом или преподавателем. Имеет доступ ко всем чатам и перепискам.</li>
    <li>Преподаватель. Имеет доступ общим чатам групп в которых он преподаёт и имеет возможность лично написать каждому студенту.</li>
    <li>Студент. Имеет доступ чату своей группы и имеет возможность лично написать каждому студенту или преподователю.</li>
</ol>
